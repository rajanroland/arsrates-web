...
const AuthManager = {
    ...
    updateUI() {
        ...
        if (this.isLoggedIn()) {
            authLinks.innerHTML = `
                <li class="nav-item">
                    <a class="nav-link" href="${window.APP_CONFIG.API_URL}/alerts">My Alerts</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${window.APP_CONFIG.API_URL}/profile">Profile</a>
                </li>
                <li class="nav-item">
            ...
            authLinks.innerHTML = `
                <li class="nav-item">
                    <a class="nav-link" href="${window.APP_CONFIG.API_URL}/login">Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${window.APP_CONFIG.API_URL}/register">Register</a>
                </li>
            `;
        }
    }
